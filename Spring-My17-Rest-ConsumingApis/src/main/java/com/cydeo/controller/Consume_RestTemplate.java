...
public class Consume_RestTemplate {
    ...
    public User[] readAllUsers(){
         // get json body from the third party and converting it to DTOby using jsonschema2pojo
        /*
...
// I am manupilating my header below, I am passing some token with header then I get response
    @GetMapping("/test")
    public ResponseEntity<Object> consumeFromDummyApi(){

        HttpHeaders headers = new HttpHeaders();
        // we pass header items to get json response
